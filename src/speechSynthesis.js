...
function speakPolish() {
    const nextDaysText = ", jutro w dzień będzie " + nextDaySections[0].children[2].firstElementChild.textContent +
        ", a w nocy " + nextDaySections[0].children[2].lastElementChild.textContent +
        ". Pojutrze w dzień " + nextDaySections[1].children[2].firstElementChild.textContent +
        ",a w nocy " + nextDaySections[1].children[2].lastElementChild.textContent;
    msg.text = city.textContent.split(',')[0] + " obecnie temperatura wynosi" + tempNow.textContent + nextDaysText;
